...
/***/ function(module, exports, __webpack_require__) {
	...
	var _watch = __webpack_require__(168);
	...
	document.addEventListener('DOMContentLoaded', function () {
	  _reactDom2.default.render(_react2.default.createElement(_watch2.default, null), document.getElementById('root'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buttons = __webpack_require__(169);
	
	var _buttons2 = _interopRequireDefault(_buttons);
	
	var _splits = __webpack_require__(170);
	...
	var Watch = function (_React$Component) {
	  ...
	  function Watch(props) {
	    ...
	    _this.state = { elapsed: 0, running: false, splits: [] };
	    _this.tick = _this.tick.bind(_this);
	    _this.button1Clicked = _this.button1Clicked.bind(_this);
	    _this.button2Clicked = _this.button2Clicked.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Watch, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_display2.default, { elapsed: this.state.elapsed }),
	        ...
	        _react2.default.createElement(_splits2.default, { splits: this.state.splits })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Splits = exports.Splits = function (_React$Component) {
	  _inherits(Splits, _React$Component);
	
	  function Splits() {
	    _classCallCheck(this, Splits);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Splits).apply(this, arguments));
	  }
